    ...
    return (
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:felx lg:flex-col">

                    <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
                        Contact me for collaboration
                    </h2>
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        I am always open to discussing new projects, creative ideas or opportunities to be part of your vision. Whether you have a specific project in mind or just want to say hello, I would love to hear from you.                    
                    </p>
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            <a key={key} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg trasnition-[background-color] duration-200 hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up" rel="noopener noreferrer">
                                {icon}
                            </a>
                        ))}
                    </div>
                ...
                <form action="https://getform.io/f/akkyjgda" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" name="email" autoComplete="email" required placeholder="cristianwalle@example.com" id="email" className="text-field  reveal-up" />
                        </div>
                    </div>
